...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <%    MovimientoDAO dao = new MovimientoDAO();
            ...
            int id = Integer.parseInt(request.getSession().getAttribute("FactComp").toString());
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="RefFacturaCompraController">
                    <input type="hidden" name="accion" value="RegistrarrefFacturadecompra" />
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control form-control-sm" name="txtCorrelativo" value="" required="">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                    ...
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ...
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("FacturaCompra");
                                                int fila = 0;
