    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idproxalmfb"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="FacturaventaController" accion="AnadirCarritofb"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosfb.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritofb"/>
                    </div>
                </form>
            </div>
        </div>
