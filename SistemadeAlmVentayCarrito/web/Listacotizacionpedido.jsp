                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    ...
                                    <br>
                                    <h6 style="color: white;">Detalle y Eliminar las Cotizacion</h6>
                                </div>
                                <div class="card-body"> 
                                    <div class="row">
                                    ...
                                    <div class="full-width panel-content" id="div1">
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Pendiente")) {%>
                                                <a href="RefCotiaPedidoventaController?accion=refPe&id=<%=vent.getIdmovimiento()%>" class="btn-sm btn-primary" class="anular">Generar Pedido</a>
                                                <%   } else { %>
