    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="RefCotiaPedidoventaController">
                    <input type="hidden" name="accion" value="RegistrarrefPedido" />
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="txtTipodoc" id="tipo_comprobante" required="" class="form-control form-control-sm">
                                                        <option value="Pedido de Venta">PEDIDO DE VENTA</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-2">
                                                    <input class="form-control form-control-sm" name="txtSerie" value="P001" required="">
                                                </div>
                                                <div class="col-sm-3">
                                    ...
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ...
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("PedidVenta");
                                                int fila = 0;
            ...
            <script src="Validacionysweetalert/RefPedidoventa.js" type="text/javascript"></script>
