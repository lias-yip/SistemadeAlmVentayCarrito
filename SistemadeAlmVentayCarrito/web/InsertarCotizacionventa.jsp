...
<html lang="en">
    ...
    <%  Auxiliar objClienteCO = null;
        if (request.getSession().getAttribute("clienteCO") != null) {
            objClienteCO = (Auxiliar) request.getSession().getAttribute("clienteCO");
        } else {
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="CotizacionventaController">
                    <input type="hidden" name="accion" value="Registrarcotizacion" />
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h3 class="card-title" style=" color: #fff;">
                                        EMITIR COTIZACION DE VENTA
                                    </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                     <input class="form-control form-control-sm" name="txtTipodoc" value="Cotizacion de venta" readonly="">
                                                   
                                                </div>
                                            </div>
                                            <% MovimientoDAO com = new MovimientoDAO();
                                                String numserie = com.NumserieCoti();
                                            %>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Número:</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control form-control-sm" name="txtSerie" value="CT01" readonly="">
                                                </div>
                                                <div class="col-sm-3">
                                    ...
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ...
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("carco");
                                                int fila = 0;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:4px;">
                                                        <input class="form-control form-control-sm" style="width : 110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCosto())%>" id="txtPro_precio<%=fila%>" name="txtPro_precio" step="0.01" min="0.01" onchange="actualizarpreciocompra(<%= fila%>)" required="">
                                                    </td>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <a href="ProductosActivosco.jsp" class="btn btn-primary float-right"  role="button" style="height: 30px;display: inline-block;margin-bottom: 0;font-weight: bold;text-align: center;vertical-align: middle;letter-spacing: 1px;text-transform: uppercase;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;transition: all 0.2s;background-image: none;border: 2px solid transparent;white-space: nowrap;padding: 2px 18px;font-size: 12px;line-height: 1.78571;border-radius: 20px;-webkit-user-select: none;-ms-user-select: none;user-select: none;padding-top: 3px;">Agregar Item</a>
                                                    <a class="btn btn-secondary" href="CotizacionventaController?accion=Limpiarco">Limpiar</a> 
                                                    <a class="btn btn-primary float-right" href="ListarCotizacionventa.jsp" role="button">Salir</a>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ClienteController?accion=buscarPorIdCO&idClienteCO=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td ><%=p.getCodigo()%></td>
                                                <td ><%=p.getNombre()%></td>
            ...
            <script src="Validacionysweetalert/Cotizacion.js" type="text/javascript"></script>
