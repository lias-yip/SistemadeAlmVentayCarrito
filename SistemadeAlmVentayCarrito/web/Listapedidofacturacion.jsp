                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title" style="color: white;">Pedido</h3>
                                    ...
                                    <br>
                                    <h6 style="color: white;">Detalle y Eliminar las Pedido</h6>
                                </div>
                                <div class="card-body"> 
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control select2" name="cbCliente" id="cbCli" required="" disabled="true"
                                                ...
                                                <%  AuxiliarDAO pdao = new AuxiliarDAO();
                                                    List<Auxiliar> prov = pdao.ListadeClientesActivos();
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2" name="cbDocu" id="cbDoc" required="" disabled="true"
                                                ...
                                                <% MovimientoDAO vddao = new MovimientoDAO();
                                                    List<Movimiento> vdlist = vddao.ListadoCoti();
                                    ...
                                    <div class="full-width panel-content" id="div1">
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Pendiente")) {%>
                                                <a href="RefPedidoaFacturaventaController?accion=refFv&id=<%=vent.getIdmovimiento()%>" class="btn-sm btn-primary" class="anular">Generar Factura</a>
                                                <%   } else { %>
