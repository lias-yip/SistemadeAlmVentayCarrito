    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idproxalmpedi"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="PedidoventaController" accion="AnadirCarritopedi"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivospedi.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritopedi"/>
                    </div>
                </form>
            </div>
        </div>
