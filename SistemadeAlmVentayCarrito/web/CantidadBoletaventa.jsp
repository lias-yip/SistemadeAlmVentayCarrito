    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idproxalmbo"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="BoletaventaController" accion="AnadirCarritobo"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosbo.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritobo"/>
                    </div>
                </form>
            </div>
        </div>
