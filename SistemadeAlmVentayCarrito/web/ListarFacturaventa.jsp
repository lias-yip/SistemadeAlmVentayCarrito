        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Administrar Factura De Venta</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <a href="Listapedidofacturacion.jsp" class="bluefacturactivaFocus js-customer-action-add btn-primary btn btn-default"><i class="fas fa-folder-plus"></i> &nbsp; FACTURA DESDE PEDIDO DE VENTA</a>
                                <a href="InsertarFacturaventa.jsp" class="bluefacturactivaFocus js-customer-action-add btn-success btn btn-default" ><i class="fas fa-folder-plus"></i> &nbsp; NUEVO DIRECTO</a>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h2 class="card-title">LISTA FACTURA DE VENTA</h2>
                                        ...
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%  MovimientoDAO vdao = new MovimientoDAO();
                                                    List<Movimiento> vlist = vdao.ListadoFactura();
        ...
        <div id="editarestad" class="modal fade" >
            <div class="modal-dialog" role="document" style="z-index: 9999; width: 450px">
                <div class="modal-content">
                    <form id="editarestado"  method="post" action="FacturaventaController" name="frm_edit"> 
                        ...
                        <div class="modal-footer">
                            <a href="ListarFacturaventa.jsp" class="btn btn-default" >Cancelar</a> 
