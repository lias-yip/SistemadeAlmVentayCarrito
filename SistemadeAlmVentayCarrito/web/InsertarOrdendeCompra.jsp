...
<html lang="en">
    ...
    <%  Auxiliar objProvedorOC = null;
        if (request.getSession().getAttribute("proveedorOC") != null) {
            objProvedorOC = (Auxiliar) request.getSession().getAttribute("proveedorOC");
        } else {
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="OrdenCompraController">
                    <input type="hidden" name="accion" value="Registrarordendecompra" />
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <a class="btn btn-secondary" href="OrdenCompraController?accion=Limpiaroc">Limpiar</a> 
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ProveedorController?accion=buscarPorIdOC&idProveedorOC=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td ><%=p.getCodigo()%></td>
                                                <td ><%=p.getNombre()%></td>
