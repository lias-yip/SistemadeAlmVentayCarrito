                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("Se elimino el item", {
                            ...
                            if (willDelete) {
                                parent.location.href = "FacturaventaController?accion=procesarCarritofb";
                            }
...
function Ventaactualizarcantidad(idproducto) {
    ...
    window.location.href = "FacturaventaController?accion=actualizarcantidadfb&cantfb=" + cantidad + "&idproductofb=" + idproducto;
}
//actualizar ´Costo

function actualizarprecioventa(idproducto) {

    var pcompra = $("#txtPro_precio" + idproducto).val();
    window.location.href = "FacturaventaController?accion=actualizarcostofb&costfb=" + pcompra + "&idproductofb=" + idproducto;
}
//funcion guardar
$(function () {
    $("#newventa").on("submit", function (e) {
        ...
        $.post("FacturaventaController?accion=Registrarfacturaboleta", data, function (res, est, jqXHR) {
            if (res === "oki") {
                ...
                swal("No se guardo la informacion",{
                    icon: "warning"
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                parent.location.href = "InsertarFacturaventa.jsp";
                            }
...
$(function () {
    $("#editarestado").on("submit", function (e) {
        ...
        $.post("FacturaventaController?accion=Anular", data, function (res, est, jqXHR) {
            if (res ==="ok") {
...
//                        console.log(idv);
//                        var data = {"accion": "estadoanularfb", id: idv};
//                        $.post("FacturaventaController", data, function (res, est, jqXHR) {
//                            //console.log('res ',res);
//
//
//                            //console.log(est);  
            ...
            dangerMode: true
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        var idv = fila.find('#idv').text();
                        console.log(idv);
                        var data = {"accion": "Eliminar", idFc: idv};
                        $.post("FacturaventaController", data, function (res, est, jqXHR) {
                            //console.log('res ',res);
                            //console.log(est);  
                            if (jqXHR.status === 200) {
