...
<html lang="en">
    ...
    <%  Auxiliar objClienteFB = null;
        if (request.getSession().getAttribute("clienteBO") != null) {
            objClienteFB = (Auxiliar) request.getSession().getAttribute("clienteBO");
        } else {
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                     <input class="form-control form-control-sm" name="txtTipodoc" value="Boleta de venta" readonly="">
                                                </div>
                                            </div>
                                            <% MovimientoDAO com = new MovimientoDAO();
                                                String numserie = com.NumserieBoleta(); 
                                            %>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Número:</label>
                                                <div class="col-sm-2">
                                                    <input class="form-control form-control-sm" name="txtSerie" value="B001" readonly="">
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" type="text" id="txtTienda" name="txtTienda" value="PLASTITEX S.A.C.">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <label class="col-sm-3 col-form-label" style="text-align:right">Tienda:</label>
                                    ...
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ...
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("carbo");
                                                int fila = 0;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  style="width:5px;">
                                                        <input  class="form-control form-control-sm" style="width : 110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="ActualizarcantidadBO(<%= fila%>)" required>
                                                    </td>
                                                    <td style="width:100px; text-align: center;">
                                                        <p><%=UnidadVentaDAO.getUndVenta(ni.getIdproducto())%></p>
                                                    </td>
                                                    <td style="width:4px;">
                                                        <input class="form-control form-control-sm" style="width : 110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCosto())%>" id="txtPro_precio<%=fila%>" name="txtPro_precio" step="0.01" min="0.01" onchange="actualizarprecioBO(<%= fila%>)" required="">
                                                    </td>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ClienteController?accion=buscarPorIdBO&idClienteBO=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td ><%=p.getCodigo()%></td>
                                                <td ><%=p.getNombre()%></td>
            ...
            <script src="Validacionysweetalert/Boletaventa.js" type="text/javascript"></script>
