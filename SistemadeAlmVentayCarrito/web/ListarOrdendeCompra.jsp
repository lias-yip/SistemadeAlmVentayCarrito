        ...
        <div class="content-wrapper">          
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Administrar Orden De Compra</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <a href="ListarRequerimiento.jsp" class="bluefacturactivaFocus js-customer-action-add btn-primary btn btn-default"><i class="fas fa-folder-plus"></i> &nbsp; Desde Requerimiento</a>
                                <a href="InsertarOrdendeCompra.jsp" class="bluefacturactivaFocus js-customer-action-add btn-success btn btn-default"><i class="fas fa-folder-plus"></i> &nbsp; NUEVO</a>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="card card-primary card-tabs">
                                <div class="card-header">
                                    <h3 class="card-title" style="color: white;">LISTAR ORDEN DE COMPRA</h3>
        ...
        <div id="editarestad" class="modal fade" >
            <div class="modal-dialog" role="document" style="z-index: 9999; width: 450px">
                <div class="modal-content">
                    <form id="editarestado"  method="post" action="OrdenCompraController" name="frm_edit"> 
                        ...
                        <div class="modal-footer">
                            <a href="ListarOrdendeCompra.jsp" class="btn btn-default" >Cancelar</a> 
