    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("idproxalmco"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="CotizacionventaController" accion="AnadirCarritoco"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosco.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritoco"/>
                    </div>
                </form>
            </div>
        </div>
