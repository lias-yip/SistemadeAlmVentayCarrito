...
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;Administrar Factura De Compra</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <a href="Generardocumentodecompras.jsp" class="bluefacturactivaFocus js-customer-action-add btn-success btn btn-default" ><i class="fas fa-folder-plus"></i> &nbsp; NUEVO</a>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h2 class="card-title">LISTA FACTURA DE COMPRA</h2>
                                        ...
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%  MovimientoDAO vdao = new MovimientoDAO();
                                                    List<Movimiento> vlist = vdao.Facturadecompra();
                                                ...
                                                %>
                                                <tr>
                                                    <td style="display:none;" id="idfc"><%= vent.getIdmovimiento()%></td>
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Terminado")) {%>
                                                <a class="btn-primary btn-sm editbtn"  data-toggle="modal" data-target="#editarestad"><i class="glyphicon glyphicon-ban-circle" data-toggle="tooltip" title="Anular"></i></a>
                                                ...
                                                <%     }
                                                %>
                                                <a href="DetallePDFController?accion=DetalleFC&id=<%= vent.getIdmovimiento()%>" class="btn-sm btn-success" title="Detalle de Nota de Ingreso">Detalle</a>
                                            </td>
                                            <%
                                                }
                                            %>
                ...
                <div class="modal-content">
                    <form id="editarestado"  method="post" action="NotadeIngresoController" name="frm_edit"> 
                        ...
                        <div class="modal-footer">
                            <a href="ListarFacturadeCompra.jsp" class="btn btn-default" >Cancelar</a> 
    ...
    <script src="Validacionysweetalert/RefFacturadeCompra.js" type="text/javascript"></script>
    <script >
