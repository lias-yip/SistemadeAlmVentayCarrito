                                        ...
                                        <table id="B" class="table table-striped table-bordered second" style="width:100%">
                                            ...
                                            <tbody>
                                                <%  MovimientoDAO vdao = new MovimientoDAO();
                                                    List<Movimiento> vlist = vdao.ListadoNotaIngresoNIIC();
                                                ...
                                                %>
                                                <tr>
                                                    <td style="display:none;"><%= vent.getIdmovimiento()%></td>
                                            ...
                                            <td>
                                                <%
                                                    if (Estado.equalsIgnoreCase("Pendiente")) {%>
                                                <a href="RefFacturaCompraController?accion=refFc&id=<%=vent.getIdmovimiento()%>" class="btn-sm btn-dark" style="background: #4c64e8;color:#fff;" title="Generar Factura de Compra">Factura de Compra</a>
                                                <%   } else { %>
                                                <%     }
                                                %>
                                                <a href="DetallePDFController?accion=DetalleNICompra&id=<%= vent.getIdmovimiento()%>" class="btn-sm btn-success" title="Detalle de Nota de Ingreso">Detalle</a>
                                            </td>
                                            <%
                                                }
                                            %>
