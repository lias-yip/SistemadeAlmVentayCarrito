    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("req"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="RequerimientoController" accion="AnadirCarritoreq"> 
                    ...
                    <div class="modal-footer">
                        <a href="ProductosActivosreq.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritoreq"/>
                    </div>
                </form>
            </div>
        </div>
