    ...
    <body>
        ...
        <div >
            <%
                ...
                int id = Integer.parseInt((String) request.getAttribute("refoc"));
            ...
            <div class="modal-content">
                ...
                <form method="post" action="RefRequerimientoaOCController" accion="AnadirCarritorefoc"> 
                    ...
                    <div class="modal-footer">
                        <a href="RefProductosActivosOC.jsp" class="btn btn-default" >Cancelar</a> 
                        <input type="submit" value="Añadir" class="btn btn-success" name="btnAnadir">
                        <input type="hidden" name="accion" value="AnadirCarritorefoc"/>
                    </div>
                </form>
            </div>
        </div>
