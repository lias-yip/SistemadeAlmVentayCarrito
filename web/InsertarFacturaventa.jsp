...
<html lang="en">
    ...
    <%  Auxiliar objClienteFB = null;
        if (request.getSession().getAttribute("clienteFB") != null) {
            objClienteFB = (Auxiliar) request.getSession().getAttribute("clienteFB");
        } else {
            objClienteFB = new Auxiliar();
            objClienteFB.setIdauxiliar(0);
            objClienteFB.setCorreo("");
            objClienteFB.setNumerodocumento("0");
            objClienteFB.setNombre("");
            objClienteFB.setDireccion("");
        }
    %>
    <body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="newventa" method="post" name="accion" action="FacturaventaController">
                    <input type="hidden" name="accion" value="Registrarfacturaboleta" />
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                     <input class="form-control form-control-sm" name="txtTipodoc" value="Factura de venta" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-2">
                                                    <input class="form-control form-control-sm" name="txtSerie" value="F001" readonly="">
                                                </div>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="input-group input-group-sm">
                                                        <input type="hidden" name="txtIdcli" value="<%=objClienteFB.getIdauxiliar() == 0 ? "" : objClienteFB.getIdauxiliar()%>" class="form-control" required="">
                                                        <input type="text" name="txtNombre" value=" <%=objClienteFB.getNombre()%>" class="form-control" required="">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" name="txtI" value="<%=objClienteFB.getNumerodocumento()%>">
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control form-control-sm" type="text" name="txtdirecc" value="<%=objClienteFB.getDireccion()%>">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-wrapper">
                                        <table width="100% " class="table_fill table-striped">
                                            ...
                                            <%
                                                ...
                                                ArrayList<DetalleMovimiento> listar = (ArrayList<DetalleMovimiento>) session.getAttribute("carfb");
                                                int fila = 0;
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  style="width:5px;">
                                                        <input  class="form-control form-control-sm" style="width : 110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCantidad())%>" placeholder="1.00" step="0.01" min="0.01" id="txtPro_cantidad<%=fila%>" name="txtPro_cantidad"  onchange="Ventaactualizarcantidad(<%= fila%>)" required>
                                                    </td>
                                                    <td style="width:100px; text-align: center;">
                                                        <p><%=UnidadVentaDAO.getUndVenta(ni.getIdproducto())%></p>
                                                    </td>
                                                    <td style="width:4px;">
                                                        <input class="form-control form-control-sm" style="width : 110px; text-align:center;" type="number" value="<%=String.format("%.2f", ni.getCosto())%>" id="txtPro_precio<%=fila%>" name="txtPro_precio" step="0.01" min="0.01" onchange="actualizarprecioventa(<%= fila%>)" required="">
                                                    </td>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <a href="ProductosActivosfb.jsp" class="btn btn-primary float-right"  role="button" style="height: 30px;display: inline-block;margin-bottom: 0;font-weight: bold;text-align: center;vertical-align: middle;letter-spacing: 1px;text-transform: uppercase;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;transition: all 0.2s;background-image: none;border: 2px solid transparent;white-space: nowrap;padding: 2px 18px;font-size: 12px;line-height: 1.78571;border-radius: 20px;-webkit-user-select: none;-ms-user-select: none;user-select: none;padding-top: 3px;">AGREGAR ITEM</a>
                                                    <a class="btn btn-secondary" href="FacturaventaController?accion=Limpiarfb">Limpiar</a> 
                                                    <a class="btn btn-primary float-right" href="ListarFacturaventa.jsp" role="button">Salir</a>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:8%">
                                                    ...
                                                    <a  href="ClienteController?accion=buscarPorIdFB&idClienteFB=<%=p.getIdauxiliar()%>" ><i class="glyphicon glyphicon-plus-sign" style="color: #09bb04" data-toggle="tooltip" title="agregar"></i></a>
                                                </td>
                                                <td ><%=p.getCodigo()%></td>
                                                <td ><%=p.getNombre()%></td>
            ...
            <script src="Validacionysweetalert/Facturaventa.js" type="text/javascript"></script>
