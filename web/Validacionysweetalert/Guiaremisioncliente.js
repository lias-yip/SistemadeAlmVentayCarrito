                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("Item eliminado", {
                            ...
                            if (willDelete) {
                                parent.location.href = "GuiaremisionclienteController?accion=procesarCarritogrc";
                            }
...
function actualizarcantidad(idproducto) {
    ...
    window.location.href = "GuiaremisionclienteController?accion=actualizarcantidadgrc&cantgrc=" + cantidad + "&idproductogrc=" + idproducto;
}
//funcion guardar
$(function () {
    $("#newventa").on("submit", function (e) {
        ...
        $.post("GuiaremisionclienteController?accion=Registrarguiaremisoncliente", data, function (res, est, jqXHR) {
            if (res === "oki") {
                swal("Se ha guardado la informacion", {
                    icon: "success"
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                parent.location.href = "ListarGuiaremisioncliente.jsp";
                            }
                ...
                swal("¡No se inserto la venta! ", "¡ Hiciste clic en el botón! ", " éxito ", {
                    icon: "warning"
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                parent.location.href = "InsertarGuiaremisioncliente.jsp";
                            }
            ...
            dangerMode: true
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        console.log(idv);
                        var data = {"accion": "estadoanulargrc", id: idv};
                        $.post("GuiaremisionclienteController", data, function (res, est, jqXHR) {
                            //console.log('res ',res);
