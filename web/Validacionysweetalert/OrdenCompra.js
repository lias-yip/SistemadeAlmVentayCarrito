                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        swal("Se elimino el item", {
                            ...
                            if (willDelete) {
                                parent.location.href = "OrdenCompraController?accion=procesarCarritooc";
                            }
...
function Ventaactualizarcantidad(idproducto) {
    ...
    window.location.href = "OrdenCompraController?accion=actualizarcantidadoc&cantoc=" + cantidad + "&idproductooc=" + idproducto;
}
//actualizar ´Costo
...
function actualizarpreciocompra(idproducto) {
    ...
    window.location.href = "OrdenCompraController?accion=actualizarcostooc&costoc=" + pcompra + "&idproductooc=" + idproducto;
}
//funcion guardar
$(function () {
    $("#newventa").on("submit", function (e) {
        ...
        $.post("OrdenCompraController?accion=Registrarordendecompra", data, function (res, est, jqXHR) {
            if (res === "oki") {
                ...
                swal("No se guardo la informacion",{
                    icon: "warning"
                        ...
                        .then((willDelete) => {
                            if (willDelete) {
                                parent.location.href = "InsertarOrdendeCompra.jsp";
                            }
...
$(function () {
    $("#editarestado").on("submit", function (e) {
        ...
        $.post("OrdenCompraController?accion=Anular", data, function (res, est, jqXHR) {
            if (res ==="ok") {
            ...
            dangerMode: true
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.post("OrdenCompraController", data, function (res, est, jqXHR) {
                            //console.log('res ',res);
                            //console.log(est);  
                            if (jqXHR.status === 200) {
                                //success
